...
//	static ElderBro e2=new ElderBro("Redmi","4gb","126gb",24000,"jagan",19);
	public static void main(String[] args) {
		...
		do {
			System.out.println("you can add upto two accounts.......");
			...
			case 1: {
				...
				s.nextLine();
				String Mobnam=s.nextLine();
				System.out.println("Enter Mobile RAM");
				String Mobram=s.nextLine();
				System.out.println("Enter Mobile Stroage");
				String Mobstor=s.nextLine();
				System.out.println("Enter Mobile Price");
				double Mpri=s.nextDouble();
				e = new ElderBro(Mobnam,Mobram,Mobstor,Mpri,name,age);
				do {
					...
					case 3: {
						...
						if (slot_no == 1) {
							...
							long Num = s.nextLong();
							e.addSim(new Sim(Sname, b_w, Num));
						} else if (slot_no == 2) {
							System.out.println("Enter SIM Name ");
							s.nextLine();
							String Sname = s.nextLine();
							...
							System.out.println("Enter SIM Number ");
							long Num = s.nextLong();
							e.addSim1(new Sim(Sname, b_w, Num));
						}
						break;
					}
					case 4: {
			...
			case 2: {
				...
				System.out.println("Enter Mobile Price");
				double Mpri=s.nextDouble();
				y = new YoungBro(Mobnam,Mobram,Mobstor,Mpri,name,age);
				do {
					System.out.println("1.Details of mobile\n2.Details of Sim\n3.Add_Sim\n4.Remove_sim\n5.Is_Sim_Present\n6.Exit");
					int input = s.nextInt();
					switch (input) {
					...
					case 3: {
						...
						if (slot_no == 1) {
							...
							System.out.println("Enter SIM Number ");
							long Num = s.nextLong();
							y.addSim(new Sim(Sname, b_w, Num));
						} else if (slot_no == 2) {
							System.out.println("Enter SIM Name ");
							s.nextLine();
							String Sname = s.nextLine();
							...
							System.out.println("Enter SIM Number ");
							long Num = s.nextLong();
							y.addSim1(new Sim(Sname, b_w, Num));
						}
						break;
					}
					case 4: {
